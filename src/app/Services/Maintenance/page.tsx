        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-5">
            <div className="col-span-2">
              <h2 className="text-base/7 text-green-600">
                Strategic & Effective
              </h2>
              <p className="mt-2 text-4xl font-bold tracking-tight text-pretty text-green-700 sm:text-5xl">
                Why Partner with FLORENTEK?
              </p>
              ...
              {features.map((feature) => (
                <div key={feature.name} className="relative pl-9">
                  <dt className="font-semibold text-gray-900">
                    <CheckIcon
                      aria-hidden="true"
                      className="absolute top-1 left-0 size-5 text-green-600"
                    />
                    {feature.name}
                  </dt>
